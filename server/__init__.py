...
def init_flask_restful_routes(app):
    ...
    from server.api.users.user_apis import UserAPI, UserIdAPI, UserOSMAPI, UserMappedProjects, UserSetRole, UserSetLevel,\
        ...
        UserContributionsAPI, UserValidatorRoleRequestAPI, UserValidatorRoleByIdAPI
    ...
    api.add_resource(UserValidatorRoleByIdAPI,      '/api/v1/validator/<int:id>', methods=['GET', 'DELETE', 'PUT'])
